        ...
        for (let h = 0; h < AnzahlHaltestellen; h++) {
            for (let i = 0; i < 6; i++) {
                if (existsObject(DP_userdata + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i)) == false) {
                    ...
                    await createAliasAsync(DP_AliasNSPanel + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.ACTUAL', DP_userdata + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.Abfahrzeit', true, <iobJS.StateCommon>{ type: 'string', role: 'state', name: 'Abfahrzeit' });
                    await createAliasAsync(DP_AliasNSPanel + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.Richtung', DP_userdata + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.Richtung', true, <iobJS.StateCommon>{ type: 'string', role: 'state', name: 'Richtung' });
                    await createAliasAsync(DP_AliasNSPanel + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.Fahrzeug', DP_userdata + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.Fahrzeug', true, <iobJS.StateCommon>{ type: 'string', role: 'state', name: 'Fahrzeug' });
                    await createAliasAsync(DP_AliasNSPanel + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.Verspätung', DP_userdata + 'FahrplanAnzeiger.Haltestelle' + String(h) + '.Abfahrt' + String(i) + '.Verspätung', true, <iobJS.StateCommon>{ type: 'boolean', role: 'state', name: 'Delay' });
                    console.log('Fertig')
                } else {
